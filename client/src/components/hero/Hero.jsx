  ...
  return (
    <div className="w-full flex justify-center items-center mt-16">
      <div className="w-full relative flex justify-center">
        ...
        <picture className="translate-y-[calc(20%+1rem)] md:translate-y-[calc(25%+2rem)]">
          <source
            srcSet={BgLargWp}
            type="image/webp"
        ...
        <div className="text-white flex flex-col items-center absolute z-10 top-10 min-[430px]:top-16 min-[460px]:top-20 min-[520px]:top-24 sm:top-24 md:top-12">
